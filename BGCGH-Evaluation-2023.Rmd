...
- check on family engagement surveys
...
- When will we have the 2023 NYOI files? How is this survey administered? Wondering about the number of responses.
     ...
     + taken on computer, can take 20-25 members, can be taken over multiple days.
     8 years and older, must have parent consent, members opt in with incentive program. expect 2023 data mid to late june, the surveys were completed in february, previously in oct/nov.
     +
...
- Notes from 19-20 report: number of days of BGCGH Texas ACE programming attended by a given student could not be calculated to a reasonable level of certainty because of disparities in data collection and management procedures.
    ...
    + first semester of that year was accidentally deleted
    +
...
- You sent Youth Program Quality Intervention (YPQI) data. The reports themselves and the past evaluations call it the Youth Program Quality Assessment (YPQA). What do you prefer for this report?
    ...
    + Assessment Tool is one portion of the intervention
    + training start in August, assessments in oct/nov, implementing new takes place in next calendar year
    + calendar years
    +

- Supporting parents evaluation questions?

    + in the past they used family engagement surveys. They don't know if they have any current surveys. We'll decide later if we can include this or not.
    +
