...
experience <- nyoi.2021 %>% 
  # using str_detect here because the way I merged the detail columns left spaces before them
  filter(str_detect(Measure, "Overall Club Experience")) %>% 
  select(Site, ...2,...3,...4) %>% 
