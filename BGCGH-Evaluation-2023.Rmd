...
# View(csv.list[[8]]) # Grade is character (1st), but one is listed as 1nd. Figure out what that should be.
...
age.plot <- 
  ...
  filter(Demographic == '5 to 9' | 
           Demographic == '10 to 12'| 
           Demographic == '13 to 18') %>% 
  mutate(Demographic = factor(Demographic, levels=c("5 to 9", "10 to 12", "13 to 18")))
