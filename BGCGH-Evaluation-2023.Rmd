...
attendance.plot$Site <- factor(attendance.plot$Site, levels = c("Spring Branch Elementary", "Spring Oaks Middle", "The Women's Home", "Westwood Elementary", "Woodview Elementary", "Total"), ordered = TRUE)
...
# UPDATE: these graph colors are terrible
