...
nyoi.experience <- nyoi %>% 
  filter(Measure == "Overall Club Experience") %>% 
  select(Year, Site, Optimal, Fair, "Needs Improvement") 

# %>% 
#   mutate(Optimal = as.numeric(Optimal))
#     mutate_if(is.numeric, round, digits = 2)

kable(nyoi.experience, caption = "Overall Club Experience by Site", digits = 2)
...
# Next remove percent signs - change all to numeric decimals
